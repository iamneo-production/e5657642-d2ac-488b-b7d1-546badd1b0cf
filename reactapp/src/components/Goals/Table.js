...
function Table() {
  ...
  const navigateToReports = () => {
    ...
    const loadGoals=async()=>{
        const result=await axios.get("https://8080-afbabacabedeeeebcfbfbdcabeaeaadbdbabf.project.examly.io/goals");
        setGoals(result.data);
    };
    const deleteGoal = async (id) => {
        await axios.delete(`https://8080-afbabacabedeeeebcfbfbdcabeaeaadbdbabf.project.examly.io/deletegoal/${id}`);
        loadGoals();
      };
    return(
        <div className='crud'>
