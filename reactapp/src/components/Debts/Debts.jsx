...
const Debts = () => {
  ...
  const loadDebts=async()=>{
    const result = await axios.get("https://8080-febebabeadffbfbcfbfbdcabfdecaedefadebea.project.examly.io/getDebts")
    db_getDebts(result.data);
  }
  const deleteDebt=async (id)=>{
    await axios.delete(`https://8080-febebabeadffbfbcfbfbdcabfdecaedefadebea.project.examly.io/deleteDebts/${id}`)
    loadDebts();
  }
  ...
  const handleAdd=async (e)=>{
    ...
    await axios.post("https://8080-febebabeadffbfbcfbfbdcabfdecaedefadebea.project.examly.io/Debts",sampleValues).then(response => {
